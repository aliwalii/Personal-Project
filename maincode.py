...
@bot.tree.command(name="ai-therapist", description="Talk to an AI therapist for student well-being support.")
async def ai_therapist(interaction: discord.Interaction, message: str):
    await interaction.response.defer()
    full_message = f"Act as a supportive and empathetic AI therapist. Provide thoughtful and helpful guidance for: {message}"
    response = chat.send_message(full_message)
